...
c='A';a=sel_range(c,330,340)+sel_range(c,520,530)+sel_range(c,5081,5083);refine_residues(0,a)
c='B';a=sel_range(c,330,340)+sel_range(c,520,530)+sel_range(c,5081,5083);refine_residues(0,a)
c='C';a=sel_range(c,330,340)+sel_range(c,520,530)+sel_range(c,5081,5083);refine_residues(0,a)
...
del_chains(0,'BCMNIJ');
renumber_residue_range(0,'L',1,300,2000);
renumber_residue_range(0,'H',1,223,3000);

change_chain_id(0,'L','A',1,2001,2300);
change_chain_id(0,'H','A',1,3001,3300);
